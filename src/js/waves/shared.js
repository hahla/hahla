...
var shared = function() {
    return {
        ...
        INITIAL_CHOPPINESS: INITIAL_CHOPPINESS,
        ...
        OCEAN_COORDINATES_UNIT: OCEAN_COORDINATES_UNIT,
        INITIAL_SPECTRUM_UNIT: INITIAL_SPECTRUM_UNIT,
        SPECTRUM_UNIT: SPECTRUM_UNIT,
        DISPLACEMENT_MAP_UNIT: DISPLACEMENT_MAP_UNIT,
        NORMAL_MAP_UNIT: NORMAL_MAP_UNIT,
        PING_PHASE_UNIT: PING_PHASE_UNIT,
        PONG_PHASE_UNIT: PONG_PHASE_UNIT,
        PING_TRANSFORM_UNIT: PING_TRANSFORM_UNIT,
        PONG_TRANSFORM_UNIT: PONG_TRANSFORM_UNIT,
        UI_COLOR: UI_COLOR,
        ...
        CHOPPINESS_SCALE: CHOPPINESS_SCALE,
        ...
        SLIDER_LEFT_COLOR: SLIDER_LEFT_COLOR,
        SLIDER_RIGHT_COLOR: SLIDER_RIGHT_COLOR,
        FOV: FOV,
        NEAR: NEAR,
        FAR: FAR,
        MIN_ASPECT: MIN_ASPECT,
        WIND_SPEED_DECIMAL_PLACES: WIND_SPEED_DECIMAL_PLACES,
        SIZE_DECIMAL_PLACES: SIZE_DECIMAL_PLACES,
        CHOPPINESS_DECIMAL_PLACES: CHOPPINESS_DECIMAL_PLACES,
        SENSITIVITY: SENSITIVITY,
        WIND_SPEED_X: WIND_SPEED_X,
        MIN_WIND_SPEED_Z: MIN_WIND_SPEED_Z,
        WIND_SPEED_OFFSET: WIND_SPEED_OFFSET,
        OVERLAY_DIV_ID: OVERLAY_DIV_ID,
        PROFILE_CANVAS_ID: PROFILE_CANVAS_ID,
        SIMULATOR_CANVAS_ID: SIMULATOR_CANVAS_ID,
        UI_DIV_ID: UI_DIV_ID,
        CAMERA_DIV_ID: CAMERA_DIV_ID,
        WIND_SPEED_DIV_ID: WIND_SPEED_DIV_ID,
        WIND_SPEED_SPAN_ID: WIND_SPEED_SPAN_ID,
        CHOPPINESS_DIV_ID: CHOPPINESS_DIV_ID,
        SIZE_SLIDER_X: SIZE_SLIDER_X,
        SIZE_SLIDER_Z: SIZE_SLIDER_Z,
        SIZE_SLIDER_LENGTH: SIZE_SLIDER_LENGTH,
        MIN_SIZE: MIN_SIZE,
        MAX_SIZE: MAX_SIZE,
        SIZE_SLIDER_BREADTH: SIZE_SLIDER_BREADTH,
        SIZE_HANDLE_SIZE: SIZE_HANDLE_SIZE,

        CHOPPINESS_SLIDER_X: CHOPPINESS_SLIDER_X,
        CHOPPINESS_SLIDER_Z: CHOPPINESS_SLIDER_Z,
        CHOPPINESS_SLIDER_LENGTH: CHOPPINESS_SLIDER_LENGTH,
        MIN_CHOPPINESS: MIN_CHOPPINESS,
        MAX_CHOPPINESS: MAX_CHOPPINESS,
        CHOPPINESS_SLIDER_BREADTH: CHOPPINESS_SLIDER_BREADTH,
        CHOPPINESS_HANDLE_SIZE: CHOPPINESS_HANDLE_SIZE,

        ARROW_TIP_RADIUS: ARROW_TIP_RADIUS,
        SIZE_HANDLE_RADIUS: SIZE_HANDLE_RADIUS,
        CHOPPINESS_HANDLE_RADIUS: CHOPPINESS_HANDLE_RADIUS,

        NONE: NONE,
        ORBITING: ORBITING,
        ROTATING: ROTATING,
        SLIDING_SIZE: SLIDING_SIZE,
        SLIDING_CHOPPINESS: SLIDING_CHOPPINESS,
        ...
        subtractFromVector: subtractFromVector,
        multiplyVectorByScalar: multiplyVectorByScalar,
        makeIdentityMatrix: makeIdentityMatrix,
        makeXRotationMatrix: makeXRotationMatrix,
        makeYRotationMatrix: makeYRotationMatrix,
        distanceBetweenVectors: distanceBetweenVectors,
        lengthOfVector: lengthOfVector,
        setVector4: setVector4,
        projectVector4: projectVector4,
        transformVectorByMatrix: transformVectorByMatrix,
        invertMatrix: invertMatrix,
        premultiplyMatrix: premultiplyMatrix,
        makePerspectiveMatrix: makePerspectiveMatrix,
        clamp: clamp,
        log2: log2,
        buildProgramWrapper: buildProgramWrapper,
        ...
        hasWebGLSupportWithExtensions: function (extensions) {
